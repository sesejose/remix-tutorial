...
// This function is used by the action function in root to handle the request / form submision
// The fakeContacts s just a fake DB table - in a real case it maybe a table in Supabase
